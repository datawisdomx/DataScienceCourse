...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 20 19:07:11 2021
...
# Use the data science process steps given in chapter 6 to build the SVC multiclass model
...
# Create the SVM Multiclass Classifier
classifier = SVC()
