...
histdata.plot.bar(x='bins', y='frequency', rot=0, position=0, width=8, title='Total No of Students in intervals of 10 Marks',
...
normaldata.plot(kind='bar', position=0, width=4, figsize=(4,6))
plt.show()
