...
import os
os.chdir('/Users/nitinsinghal/DataScienceCourse/Part1-MachineLearningDataAnalytics/RoboadvisorData/')
...
def asset_data_wrangling():
    ...
    print('\n Performing Data Wrangling of Asset Data(Formatting, Cleaning) ...')
    ...
    print('\n Performing Data Wrangling (Merging) ...')
...
def macro_data_wrangling():    
    ...
    print('\n Performing Data Wrangling of Macro Data(Formatting, Merging) ...')
    ...
    print('\n Performing Data Wrangling of CentralBank Forecast Data(Formatting, Merging) ...')
