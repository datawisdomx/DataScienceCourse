...
print('\n FrcstPred Portfolio Variance(Volatility): %.4f, Std Dev: %.12f' %(FrcstPredPortfolioVariance, FrcstPredPortfolioStdDev))
...
print('\n Predicted Portfolio Variance(Volatility): %.4f, Std Dev: %.12f' %(PredPortfolioVariance, PredPortfolioStdDev))
