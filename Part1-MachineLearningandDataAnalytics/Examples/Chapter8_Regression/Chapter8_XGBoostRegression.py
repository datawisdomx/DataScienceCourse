...
# XGBoost Regression - Bond Price prediction using macroeconomic data for US
...
estimator = XGBRegressor(objective ='reg:squarederror', learning_rate=1, max_depth=6, seed=1)
...
plt.title('XGBoost Regression - 10yr Bond Price vs Macroeconomic factors')
