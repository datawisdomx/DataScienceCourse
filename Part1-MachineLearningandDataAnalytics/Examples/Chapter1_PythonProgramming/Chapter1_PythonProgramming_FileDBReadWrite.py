...
#MySQL database connect, read/write commands
...
cursor.execute("INSERT INTO Users (username, password) VALUES ('John','John3')")
cursor.execute("INSERT INTO Users (username, password) VALUES ('Tom','Tom2')")
